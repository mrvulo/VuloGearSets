...
ns:RegisterLocale("deDE", {
    ...
    ["Chest"] = "Brust",
    ["Choose what opens the item picker on an equipment slot. On hover it opens by itself after a moment and stays open while the mouse is on the slot or the popup."] = "Lege fest, was die Item-Auswahl an einem Ausrüstungs-Slot öffnet. Beim Überfahren geht sie nach einem Moment von selbst auf und bleibt offen, solange die Maus auf dem Slot oder dem Fenster liegt.",
    ...
    ["Off Hand"] = "Schildhand",
    ["On hover (no click)"] = "Beim Überfahren (ohne Klick)",
    ...
    ["Wrist"] = "Handgelenk",
    ["Yes"] = "Ja",
    ["|cffaaaaaaHover an equipment slot in the character window to see all compatible items from your bags and click one to equip it. The picker only opens when there is something to swap.|r"] = "|cffaaaaaaFahre im Charakterfenster über einen Ausrüstungs-Slot, um alle passenden Teile aus deinen Taschen zu sehen, und klicke eines zum Anlegen. Die Auswahl geht nur auf, wenn es etwas zu wechseln gibt.|r",
